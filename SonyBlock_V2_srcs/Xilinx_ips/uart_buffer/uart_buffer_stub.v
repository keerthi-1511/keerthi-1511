...
// Command     : write_verilog -force -mode synth_stub -rename_top uart_buffer -prefix
//               uart_buffer_ uart_buffer_stub.v
// Design      : uart_buffer
...
module uart_buffer(clk, srst, din, wr_en, rd_en, dout, full, empty)
